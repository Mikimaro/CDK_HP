			...
			<section class="eventContents">
				...
				<div class="details">
					...
					<div id="eventDetail">
						...
						四つのお題の中から一つの項目を選択し、Scratchで作品を作ります。<br>
						【中級者向け】<br>
						・シューティングゲーム<br>
						・パズルゲーム<br>
						・塗りつぶしゲーム（某いかゲームのようなもの）<br>
						【上級者・大人用】<br>
						・Scrarchを使用したツール（拡張ツール・他言語変換ツール）<br>
						...
						<p class="contentsText">
							<ul class="contentsText">
								<li>ノートパソコン</li>
								<li>ノートパソコンの充電器</li>
								<li>（もしあれば）Wi-Fiルーター</li>
								<li>その他、自分が使いたいデバイス（Raspberry Pi等）</li>
							</ul>
						</p>
