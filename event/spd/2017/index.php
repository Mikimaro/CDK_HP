...
<body>
    ...
    <div id="main">
        ...
        <div id="about">
            ...
            <p class="mainText">
                今年も素晴らしい作品の数々が発表されました。子どもたちにとって、自分で作った作品を自分の言葉で発表する機会はとても大切です。CoderDojo Kashiwaでは、このような経験をより多くの子どもたちにしてもらいたいと考えています。<br>
                私たちの活動は2018年3月で100回を迎えます。引き続き、私たちのミッションである「市内のどこにいてもプログラミングを学べる場所を提供する」ことを実現するために邁進していきます。来年もCoderDojo Kashiwaをよろしくお願いいたします。
