  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    <nav class="navbar navbar-expand-lg navbar-light" id="menu">
        <a class="navbar-brand" href="./">
            <img src="./image/dojoLogo.png" class="homeLogo">
        </a>
        <button class="navbar-toggler m-2 text-white" type="button" data-toggle="collapse" data-target="#navbar" aria-controls="navbar" aria-expanded="false" aria-label="Toggle navigation">
            <i class="fa fa-bars"></i>
        </button>

        <div class="collapse navbar-collapse" id="navbar">
            <ul class="navbar-nav nav-fill w-100 align-items-start text-center">
                <li class="nav-item">
                    <a class="nav-link" href="./about.php">ミッション</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="./dojo/">近くのDojo</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="./join.php">参加する</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="./rtd.php">RTD</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="./mentor.php">メンター</a>
                </li>
                <li class="nav-item">
